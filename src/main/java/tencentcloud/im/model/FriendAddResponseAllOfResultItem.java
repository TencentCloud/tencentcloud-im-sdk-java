 ...
 */
@JsonPropertyOrder({
  FriendAddResponseAllOfResultItem.JSON_PROPERTY_TO_ACCOUNT,
  FriendAddResponseAllOfResultItem.JSON_PROPERTY_RESULT_CODE,
  FriendAddResponseAllOfResultItem.JSON_PROPERTY_RESULT_INFO
})
@JsonTypeName("FriendAddResponse_allOf_ResultItem")
