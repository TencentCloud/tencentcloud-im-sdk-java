 ...
 */
@JsonPropertyOrder({
  FriendUpdateResponse.JSON_PROPERTY_ACTION_STATUS,
  FriendUpdateResponse.JSON_PROPERTY_ERROR_INFO,
  FriendUpdateResponse.JSON_PROPERTY_ERROR_CODE,
  FriendUpdateResponse.JSON_PROPERTY_RESULT_ITEM,
  FriendUpdateResponse.JSON_PROPERTY_FAIL_ACCOUNT,
  FriendUpdateResponse.JSON_PROPERTY_ERROR_DISPLAY
})
