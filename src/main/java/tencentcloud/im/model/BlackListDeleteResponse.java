 ...
 */
@JsonPropertyOrder({
  BlackListDeleteResponse.JSON_PROPERTY_ACTION_STATUS,
  BlackListDeleteResponse.JSON_PROPERTY_ERROR_INFO,
  BlackListDeleteResponse.JSON_PROPERTY_ERROR_CODE,
  BlackListDeleteResponse.JSON_PROPERTY_RESULT_ITEM,
  BlackListDeleteResponse.JSON_PROPERTY_FAIL_ACCOUNT,
  BlackListDeleteResponse.JSON_PROPERTY_ERROR_DISPLAY
})
