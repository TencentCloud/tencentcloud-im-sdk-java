 ...
 */
@JsonPropertyOrder({
  FriendDeleteResponseAllOfResultItem.JSON_PROPERTY_TO_ACCOUNT,
  FriendDeleteResponseAllOfResultItem.JSON_PROPERTY_RESULT_CODE,
  FriendDeleteResponseAllOfResultItem.JSON_PROPERTY_RESULT_INFO
})
@JsonTypeName("FriendDeleteResponse_allOf_ResultItem")
