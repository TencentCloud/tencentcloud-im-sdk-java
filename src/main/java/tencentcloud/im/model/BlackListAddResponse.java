...
import tencentcloud.im.model.BlackListAddResponseAllOf;
 ...
 */
@JsonPropertyOrder({
  BlackListAddResponse.JSON_PROPERTY_ACTION_STATUS,
  BlackListAddResponse.JSON_PROPERTY_ERROR_INFO,
  BlackListAddResponse.JSON_PROPERTY_ERROR_CODE,
  BlackListAddResponse.JSON_PROPERTY_RESULT_ITEM,
  BlackListAddResponse.JSON_PROPERTY_FAIL_ACCOUNT,
  BlackListAddResponse.JSON_PROPERTY_ERROR_DISPLAY
})
