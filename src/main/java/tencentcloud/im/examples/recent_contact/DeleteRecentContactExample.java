...
import tencentcloud.im.model.GetRecentContactListGroupDeleteRequest;
import tencentcloud.im.model.GetRecentContactListGroupDeleteResponse;

/**
 * 删除单个会话（https://cloud.tencent.com/document/product/269/62119）
 */
public class DeleteRecentContactExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            GetRecentContactListGroupDeleteResponse result = apiInstance.deleteRecentContact(random,
