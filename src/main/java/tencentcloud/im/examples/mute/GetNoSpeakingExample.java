package tencentcloud.im.examples.mute;
...
import tencentcloud.im.model.GetNoSpeakingRequest;
import tencentcloud.im.model.GetNoSpeakingResponse;

/**
 * 查询全局禁言（https://cloud.tencent.com/document/product/269/4229）
 */
public class GetNoSpeakingExample {
