...
public class JSON {
...

    {
        gson = createGson()
            ...
            .registerTypeAdapterFactory(new com.tencentcloudapi.im.model.AllowBannedObjectRequest.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.tencentcloudapi.im.model.ForbidIllegalObjectRequest.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.tencentcloudapi.im.model.FriendGetResponseAllOfUserDataItem.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.tencentcloudapi.im.model.FriendGetResponseAllOfValueItem.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.tencentcloudapi.im.model.GetCosSigRequest.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.tencentcloudapi.im.model.GetCosSigRequestRawURLsInner.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.tencentcloudapi.im.model.GetCosSigResponse.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.tencentcloudapi.im.model.GetCosSigResponseAllOf.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.tencentcloudapi.im.model.GetCosSigResponseAllOfPreSigURLs.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.tencentcloudapi.im.model.GetGroupInfoResponseAllOfAppDefinedData.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.tencentcloudapi.im.model.GetGroupInfoResponseAllOfGroupInfo.CustomTypeAdapterFactory())
            .registerTypeAdapterFactory(new com.tencentcloudapi.im.model.GetGroupInfoResponseAllOfMemberList.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.tencentcloudapi.im.model.ModifyC2cMsgRequest.CustomTypeAdapterFactory())
            ...
            .registerTypeAdapterFactory(new com.tencentcloudapi.im.model.ModifyGroupMsgRequest.CustomTypeAdapterFactory())
