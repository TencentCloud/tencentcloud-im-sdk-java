 ...
 */
@JsonPropertyOrder({
  GetGroupInfoResponse.JSON_PROPERTY_ACTION_STATUS,
  GetGroupInfoResponse.JSON_PROPERTY_ERROR_INFO,
  GetGroupInfoResponse.JSON_PROPERTY_ERROR_CODE,
  GetGroupInfoResponse.JSON_PROPERTY_GROUP_INFO
})
