 ...
 */
@JsonPropertyOrder({
  GetJoinedGroupListResponseAllOfGroupIdList.JSON_PROPERTY_GROUP_ID,
  GetJoinedGroupListResponseAllOfGroupIdList.JSON_PROPERTY_TYPE,
  GetJoinedGroupListResponseAllOfGroupIdList.JSON_PROPERTY_NAME,
  GetJoinedGroupListResponseAllOfGroupIdList.JSON_PROPERTY_INTRODUCTION,
  GetJoinedGroupListResponseAllOfGroupIdList.JSON_PROPERTY_NOTIFICATION,
  GetJoinedGroupListResponseAllOfGroupIdList.JSON_PROPERTY_FACE_URL,
  GetJoinedGroupListResponseAllOfGroupIdList.JSON_PROPERTY_OWNER_ACCOUNT,
  GetJoinedGroupListResponseAllOfGroupIdList.JSON_PROPERTY_CREATE_TIME,
  GetJoinedGroupListResponseAllOfGroupIdList.JSON_PROPERTY_INFO_SEQ,
  GetJoinedGroupListResponseAllOfGroupIdList.JSON_PROPERTY_LAST_INFO_TIME,
  GetJoinedGroupListResponseAllOfGroupIdList.JSON_PROPERTY_LAST_MSG_TIME,
  GetJoinedGroupListResponseAllOfGroupIdList.JSON_PROPERTY_NEXT_MSG_SEQ,
  GetJoinedGroupListResponseAllOfGroupIdList.JSON_PROPERTY_MEMBER_NUM,
  GetJoinedGroupListResponseAllOfGroupIdList.JSON_PROPERTY_MAX_MEMBER_NUM,
  GetJoinedGroupListResponseAllOfGroupIdList.JSON_PROPERTY_APPLY_JOIN_OPTION
})
@JsonTypeName("GetJoinedGroupListResponse_allOf_GroupIdList")
...
public class GetJoinedGroupListResponseAllOfGroupIdList {
  ...
  **/
  @javax.annotation.Nullable
 @Size(max=300)  @ApiModelProperty(value = "群组公告 可读可写。最长300字节，不可调整")
