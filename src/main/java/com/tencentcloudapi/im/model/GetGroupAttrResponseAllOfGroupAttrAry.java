 ...
 */
@JsonPropertyOrder({
  GetGroupAttrResponseAllOfGroupAttrAry.JSON_PROPERTY_KEY,
  GetGroupAttrResponseAllOfGroupAttrAry.JSON_PROPERTY_VALUE
})
@JsonTypeName("GetGroupAttrResponse_allOf_GroupAttrAry")
