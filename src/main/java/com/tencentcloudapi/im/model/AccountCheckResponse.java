 ...
 */
@JsonPropertyOrder({
  AccountCheckResponse.JSON_PROPERTY_ACTION_STATUS,
  AccountCheckResponse.JSON_PROPERTY_ERROR_INFO,
  AccountCheckResponse.JSON_PROPERTY_ERROR_CODE,
  AccountCheckResponse.JSON_PROPERTY_RESULT_ITEM
})
